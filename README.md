...
Visit http://localhost:8000 in your browser to see the Laravel home page.
...
Visit http://localhost:8000/ping. Expected result: pong
...
Create the DB, then php artisan migrate


Access denied for user
Incorrect DB credentials
Check DB_USERNAME / DB_PASSWORD in .env


Blank page (server error 500)
Server error
